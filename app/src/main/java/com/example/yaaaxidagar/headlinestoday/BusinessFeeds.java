...
public class BusinessFeeds extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<NewsData>>{
    ...
    private static final String apiUrl="https://newsapi.org/v1/articles?source=business-insider&sortBy=top&apiKey=eb4855160b2c4bf5b70211ca90a0f7a8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsAdapter=new NewsAdapter(this,R.layout.single_view_layout,new ArrayList<NewsData>(),R.color.business_background,R.color.business_layout_background);
