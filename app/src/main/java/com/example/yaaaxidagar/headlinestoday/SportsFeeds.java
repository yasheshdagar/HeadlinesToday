...
public class SportsFeeds extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<NewsData>>{
    ...
    private static final String apiUrl="https://newsapi.org/v1/articles?source=bbc-sport&sortBy=top&apiKey=eb4855160b2c4bf5b70211ca90a0f7a8";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.bcc_menu,menu);
        return true;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsAdapter=new NewsAdapter(this,R.layout.single_view_layout,new ArrayList<NewsData>(),R.color.sports_background,R.color.sports_layout_background);
